...
public class HeartRestorationItem extends Item {
    ...
    public Text getName(ItemStack stack) {
        ...
        return defaultName.setStyle(Style.EMPTY.withColor(TextColor.fromFormatting(Formatting.DARK_RED)).withBold(false));
    }

    @Override
    public void appendTooltip(ItemStack itemStack, TooltipContext context, List<Text> tooltip, TooltipType type) {
        tooltip.add(Text.literal("Restore one heart of health on use.").formatted(Formatting.GRAY));
    }
